...
public:
    ...
    enum class ReceiptStates { GrandTotalHeader, GrandTotalFooter, GrandTotalThanks, GrandTotalDistance, HeaderTitle, HeaderDateTime, FooterTotal,FooterCustomerService, FooterPhone, BodyHeader, Body, Top, Bottom };
